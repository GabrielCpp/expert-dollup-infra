...
export const appDbPassword = new random.RandomPassword("mongo-app-user-db-password", {
  length: 16,
  special: true,
  overrideSpecial: `!#$%&*()-_=+[]{}<>:?`,
});
...
export const expertDollupAppUser = new mongodbatlas.DatabaseUser("expert-dollup-app-user", {
...
export const migrationDbPassword = new random.RandomPassword("mongo-migration-user-db-password", {
  length: 16,
  special: true,
  overrideSpecial: `!#$%&*()-_=+[]{}<>:?`,
});
...
export const expertDollupMigrationUser = new mongodbatlas.DatabaseUser("expert-dollup-migration-user", {
  authDatabaseName: "admin",
  labels: [{
      key: "migration-user",
...
export const migrationUserAuthDbPassword = new random.RandomPassword("migration-user-auth-db-password", {
  length: 16,
  special: true,
  overrideSpecial: `!#$%&*()-_=+[]{}<>:?`,
});
...
export const migrationUserAuthDb = new mongodbatlas.DatabaseUser("migration-user-auth-db", {
  authDatabaseName: "admin",
  labels: [{
      key: "migration-user",
      value: "expert-dollup migration user",
...
export const appUserAuthDbPassword = new random.RandomPassword("app-user-auth-db-password", {
  length: 16,
  special: true,
  overrideSpecial: `!#$%&*()-_=+[]{}<>:?`,
});
...
export const appUserAuthDb = new mongodbatlas.DatabaseUser("app-user-auth-db", {
  authDatabaseName: "admin",
  labels: [{
      key: "app-user",
      value: "expert-dollup migration user",
